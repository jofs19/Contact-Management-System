...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand text-uppercase" href="{{ route('login') }}">            
        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
          ...
          <ul class="navbar-nav">
            {{-- <li class="nav-item active"><a href="{{ route('contacts.company') }}" class="nav-link">Manage Companies</a></li> --}}
            <li class="nav-item active"><a href="{{ route('contacts.index') }}" class="nav-link">Manage Contacts</a></li>
          </ul>
